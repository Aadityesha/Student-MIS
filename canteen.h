...
void store::storepageswitch()
{
    ...
    cout << "     ITEMS IN MANAGE INVENTORY BEFORE PROCEEDING" << endl
         << endl;
...
void store::viewinvt()
{
    ...
    vwpr.close();
    cout << endl
         << "     QUANTITY OF ITEMS IN CANTEEN" << endl;
...
void billing::clearstat()
{
    ...
    {
        cout << endl
             << "     SALES RECORD ARE NOT CLEARED" << endl;
        cout << endl
             << "     PRESS ANY KEY TO CONTINUE" << endl;
        cout << "     ";
        getch();
...
void order::orderitem1()
{
    ...
    else
    {
        ...
        orderout.close();
        cout << endl
             << "     PRESS ANY KEY FOR NEW ORDER" << endl;
        cout << "     ";
        getch();
        orderpage();
    }
